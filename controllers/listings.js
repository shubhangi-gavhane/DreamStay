...
module.exports.searchListings = async (req, res) => {
    ...
    res.render('listings/index.ejs', { allListings: listings, searchQuery });
};
...
// Optional: Add category filtering handler here if you want to keep logic centralized
module.exports.filterByCategory = async (req, res) => {
    ...
    res.render("listings/index.ejs", { allListings, filterCategory: category });
};
